...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static class DatabasePreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            final String dbName = "radiomap.db";

            Preference prefExport = findPreference("export");
            if (prefExport != null) {
                bindPreferenceSummaryToValue(prefExport);
                prefExport.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                    @Override
                    public boolean onPreferenceClick(Preference preference) {
                        Utils.exportDb(getActivity(), dbName);
                        return false;
                    }
                });
            }

            Preference prefImport = findPreference("import");
            if (prefImport != null) {
                bindPreferenceSummaryToValue(prefImport);
                prefImport.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                    @Override
                    public boolean onPreferenceClick(Preference preference) {
                        Utils.importDb(getActivity(), dbName);
                        return false;
                    }
                });
            }
